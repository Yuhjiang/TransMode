...
class CalcGpsData(object):
    def __init__(self, segment_gps_label):
        self.data = pd.read_csv(segment_gps_label, sep=',')
    ...
    def add_timestamp(self):
        ...
        :return:
        """
        datetime = self.data['dates'] + ' ' + self.data['time']
    ...
    def calc_segment_features(self, segment_gps_features):
        ...
        for segment_ID in segment_IDs:
            ...
            pd_segment = self.data[self.data.segment_ID == segment_ID]
            ...
            with open(segment_gps_features, 'a') as f:
                (self.data[first_segment_index:first_segment_index+len(pd_segment)-1]).to_csv(
