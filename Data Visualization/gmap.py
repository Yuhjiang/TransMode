...
def getmap(wn_latitude, wn_longitude, es_latitude, es_longitude, zoom, filename='sample', source='gaode'):
    process_latlng(wn_latitude, wn_longitude, es_latitude, es_longitude, zoom, filename, source)
